...
import { HiClipboard, HiViewGridAdd } from 'react-icons/hi';
import { MdOutlineManageHistory } from 'react-icons/md';
const DashboardLayout = () => {
  const navigate = useNavigate();
  const handleLogout = () => {
    localStorage.removeItem('token'); // atau apa pun nama tokennya
    navigate('/admin');
  };
      ...
      <aside className="hidden sm:flex sm:flex-col">
        ...
        <div className="flex-grow flex flex-col justify-between text-gray-500 bg-gray-800">
          <nav className="flex flex-col mx-4 my-6 space-y-4">
            <Link
              ...
              className={`inline-flex items-center justify-center py-3 rounded-lg ${
                location.pathname === '/dashboard'
                  ...
                  : 'text-gray-400 hover:text-gray-400 hover:bg-gray-700 focus:text-gray-400 focus:bg-gray-700'
              }`}
            >
            ...
            <Link
              to="/dashboard/add-new-plant"
              className={`inline-flex items-center justify-center py-3 rounded-lg ${
                location.pathname === '/dashboard/add-new-plant'
                  ? 'text-purple-600 bg-white'
            ...
            <Link
              to="/dashboard/manage-plants"
              className={`inline-flex items-center justify-center py-3 rounded-lg ${
                location.pathname === '/dashboard/manage-plants'
                  ? 'text-purple-600 bg-white'
                  : 'hover:text-gray-400 hover:bg-gray-700 focus:text-gray-400 focus:bg-gray-700'
              }`}
            >
